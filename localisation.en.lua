...
FLIGHTMAP_OPTIONS[12] = { -- Option 12: Chat messages
  label = "Chat messages",
  option = "chatMessages",
  tooltip = "Enable/disable chat messages for route measurement and updates.",
};
...
FLIGHTMAP_MSG_NEW_ROUTE_START    = "[FlightMap] New route: %s (measuring)";
FLIGHTMAP_MSG_NEW_ROUTE_TIME     = "[FlightMap] New route time - %s: %s";
FLIGHTMAP_MSG_UPDATED_ROUTE_TIME = "[FlightMap] Updated route time - %s: %s";